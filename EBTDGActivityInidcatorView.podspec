#
#  Be sure to run `pod spec lint EBTDGActivityInidcatorView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/KBvsMJ/EBTActivityIndicatorViewDemo.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "EBTDGActivityInidcatorView/*.{h,m}"
